...
import 'package:calendar_date_picker_custom/src/widgets/calendar_date_picker_custom.dart';
import 'package:flutter/material.dart';

class CalendarDatePickerCustomWithActionButtons extends StatefulWidget {
  const CalendarDatePickerCustomWithActionButtons({
  ...
  final CalendarDatePickerCustomWithActionButtonsConfig config;
  ...
  @override
  State<CalendarDatePickerCustomWithActionButtons> createState() =>
      _CalendarDatePickerCustomWithActionButtonsState();
}

class _CalendarDatePickerCustomWithActionButtonsState
    extends State<CalendarDatePickerCustomWithActionButtons> {
  ...
  void didUpdateWidget(
      covariant CalendarDatePickerCustomWithActionButtons oldWidget) {
    var isValueSame =
