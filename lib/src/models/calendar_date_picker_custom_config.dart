...
enum CalendarDatePickerCustomType { single, multi, range }
...
class CalendarDatePickerCustomConfig {
  CalendarDatePickerCustomConfig({
    CalendarDatePickerCustomType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
  ...
  })  : calendarType = calendarType ?? CalendarDatePickerCustomType.single,
  ...
  final CalendarDatePickerCustomType calendarType;
  ...
  CalendarDatePickerCustomConfig copyWith({
    CalendarDatePickerCustomType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
    ...
    return CalendarDatePickerCustomConfig(
...
class CalendarDatePickerCustomWithActionButtonsConfig
    extends CalendarDatePickerCustomConfig {
  CalendarDatePickerCustomWithActionButtonsConfig({
    CalendarDatePickerCustomType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
  ...
  @override
  CalendarDatePickerCustomWithActionButtonsConfig copyWith({
    CalendarDatePickerCustomType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
    ...
    return CalendarDatePickerCustomWithActionButtonsConfig(
      calendarType: calendarType ?? this.calendarType,
      firstDate: firstDate ?? this.firstDate,
      lastDate: lastDate ?? this.lastDate,
      currentDate: currentDate ?? this.currentDate,
